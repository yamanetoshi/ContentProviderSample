...
public class Main2Activity extends FragmentActivity implements LoaderCallbacks<Cursor> {
    
   private SimpleCursorAdapter mAdapter;
   private ListView mListView;
   private ProgressDialog mProgressDialog;
   
   private final String TITLE = "title2";
   private final String NOTE = "note2";
               ...
               case R.id.delete:
                       ...
                       for (int i = 0 ; i < adapter.getCount(); i++) {
                           ...
                           if (checked) {
                        	   ...
                        	   Uri delUri = ContentUris.withAppendedId(Contract.Table2.contentUri, id);
   ...
   public void onCreate(Bundle savedInstanceState) {
       ...
       mListView.setOnItemClickListener(new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent i = new Intent(Main2Activity.this, Main2Edit.class);
            Uri uri = ContentUris.withAppendedId(Contract.Table2.contentUri, id);
            //Toast.makeText(getApplicationContext(), "Uri : " + uri ,Toast.LENGTH_SHORT).show();
            i.setData(uri);
            //startActivity(new Intent(Intent.ACTION_EDIT, uri));
            i.putExtra(TITLE, cursor.getString(cursor.getColumnIndex(Contract.Table2.columns.get(1))));
            i.putExtra(NOTE, cursor.getString(cursor.getColumnIndex(Contract.Table2.columns.get(2))));
            i.setAction(Intent.ACTION_EDIT);
            startActivity(i);
		}
       });
         
       // Table2テーブルのデータを全件検索. 表示.
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
	   switch (item.getItemId()) {
	   case R.id.add:
           Intent i = new Intent(this, Main2Edit.class);
           
           i.setData(Contract.Table2.contentUri);
           /*
           i.putExtra(TITLE, "");
           i.putExtra(NOTE, "");
           */
   ...
   public Loader<Cursor> onCreateLoader(int id, Bundle args) {
       ...
       return new CursorLoader(this, Contract.Table2.contentUri, null, null, null, null);
   }
