...
public class Main2Edit extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	if (Intent.ACTION_INSERT.equals(action)) {
            ...
            cv.put(Contract.Table2.columns.get(1), "");
    	...
    	btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				values.put(Contract.Table2.columns.get(1), tv_title.getText().toString());
				values.put(Contract.Table2.columns.get(2), tv_note.getText().toString());
	...
	protected void onResume() {
		...
		if (mState == STATE_EDIT) {
			if (mCursor != null) {
				mCursor.moveToFirst();
				tv_title.setText(mCursor.getString(mCursor.getColumnIndex(Contract.Table2.columns.get(1))));
				tv_note.setText(mCursor.getString(mCursor.getColumnIndex(Contract.Table2.columns.get(2))));
			}
		}
	}
}
